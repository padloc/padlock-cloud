...
class Dashboard extends applyMixins(
    ...
    connectedCallback() {
        ...
        if (this.account.displaySubscription) {
            this._setupPayment();
    ...
    _billingCycle() {
        ...
        return this.account.plan.interval === "month" ? $l("(billed monthly)") : $l("(billed annually)");
    }
