...
func NewCliApp() *CliApp {
	...
	cliApp.Flags = []cli.Flag{
		...
		cli.StringFlag{
			Name:        "email-provider",
			Value:       "",
			Usage:       "Mail Provider for sending Emails",
			EnvVar:      "EMAIL_PROVIDER",
			Destination: &config.Email.Provider,
		},
		cli.StringFlag{
			Name:        "aws-region",
			Value:       "",
			Usage:       "AWS SES Region",
			EnvVar:      "AWS_REGION",
			Destination: &config.Email.AWSRegion,
		},
		cli.StringFlag{
			Name:        "ses-from-email",
			Value:       "",
			Usage:       "Verified Identity in SES used as From:",
			EnvVar:      "SES_FROM",
			Destination: &config.Email.SESFrom,
		},
		cli.StringFlag{
			...
			Destination: &config.Email.AWSAccessKey,
		},
		cli.StringFlag{
			Name:        "aws-secret-key",
			Value:       "",
			...
			Destination: &config.Email.AWSSecretKey,
		},
		cli.StringFlag{
			Name:        "email-server",
			Value:       "",
