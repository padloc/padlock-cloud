	...
	cliApp.Commands = []cli.Command{
		{
			...
			Flags: []cli.Flag{
				...
				cli.StringFlag{
					Name:        "skeleton-key",
					Value:       "",
					Usage:       "Skeleton api key for general access. Use with skeleton-ip.",
					EnvVar:      "PC_SKELETON_KEY",
					Destination: &config.Server.SkeletonKey,
				},
				cli.StringFlag{
					Name:        "skeleton-ip",
					Value:       "",
					Usage:       "IP address allowed to use the skeleton key",
					EnvVar:      "PC_SKELETON_IP",
					Destination: &config.Server.SkeletonIP,
				},
			},
